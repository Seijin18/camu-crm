...
- [ ] 1.1 `tests/integration/`: reproduzir o cenário — rascunho com
...
- [ ] 2.1 `camucrm/db.py::purgar_mensagens_antigas`: estender a
...
- [ ] 2.2 Reconferir `resumos_conversa`: confirmar (ou corrigir, se a
...
- [ ] 3.3 `tests/integration/`: resumo de conversa encerrada é alcançado
      ...
      linha purgada").
- [ ] 3.4 Suíte de integração verde (Postgres real).
