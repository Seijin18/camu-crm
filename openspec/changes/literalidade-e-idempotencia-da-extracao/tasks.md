...
- [x] 1.1 `camucrm/extraction/contract.py::build_corpus`: trocar o separador
...
- [x] 1.2 `camucrm/extraction/contract.py::_fold`: confirmar (com teste) que
...
- [x] 2.1 `camucrm/extraction/contract.py`/`extractor.py`: definir o mapa
      ...
      lado do cliente").
- [x] 2.2 Verificar a evidência apenas contra o corpus do lado exigido —
